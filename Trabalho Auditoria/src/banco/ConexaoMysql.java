...
public class ConexaoMysql {
    ...
    public ConexaoMysql() {
    	// String de conexao
    	this.url = "jdbc:mysql://localhost:3306/prova p2?useSSL=false&allowPublicKeyRetrieval=true&useTimezone=true&serverTimezone=UTC";
        this.usuario = "rafael";   // Informe o usuario e senha
        this.senha = "2202rafael"; // do seu banco de dados
